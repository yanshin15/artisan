      ...
      <div className="flex w-[90%] h-full mx-auto">
        <div className=" grid grid-cols-2 grid-rows-2 mt-8">
          ...
          <h1 className="row-span-2">
            ...
            Recusandae, eveniet a mollitia exercitationem voluptate temporibus
            quidem ipsa dignissimos voluptatibus deleniti libero quibusdam
            labore optio quia vitae totam ullam debitis illo? Lorem ipsum dolor
            sit amet, consectetur adipisicing elit. Eveniet porro suscipit
            aspernatur, perferendis, odit ea, sit maxime vel labore a
            asperiores. Debitis magni eveniet deserunt sequi pariatur, porro
            quod enim? Lorem ipsum dolor sit amet, consectetur adipisicing elit.
            Ab sit placeat veritatis incidunt et maiores quos ullam laborum eius
            voluptate quae, est possimus totam inventore quam itaque suscipit
